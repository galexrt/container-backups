...
# Mount flags to give to the `sefs` command, to mount the bucket. For information on this check, e.g., the man page https://manpages.debian.org/unstable/s3fs/s3fs.1.en.html
